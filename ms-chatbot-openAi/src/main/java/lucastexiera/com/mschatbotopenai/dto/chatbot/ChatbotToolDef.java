...
public enum ChatbotToolDef {
    ENVIAR_DESPESA(
            ...
            Map.of(
                    "description",
                    new OpenAiMessageRequest.Property("string", "Descrição da despesa"),
                    "amount", new OpenAiMessageRequest.Property("number", "Valor da despesa"),
                    "category_id",
                    new OpenAiMessageRequest.Property("number", "Identificador da categoria"))),
    UPDATE_LAST(
            "update_last_expense",
    ...
    DELETE_CATEGORY(
            ...
            Map.of(
                    "category_id",
                    new OpenAiMessageRequest.Property("string", "ID único da categoria"),
                    "category_name", new OpenAiMessageRequest.Property("string",
