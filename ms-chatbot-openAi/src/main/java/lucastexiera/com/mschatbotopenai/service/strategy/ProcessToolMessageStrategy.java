...
public class ProcessToolMessageStrategy implements TypeMessageStrategy {

  public final ProcessUserMessageService processUserMessage;
  ...
  public ChatbotMessage handleTypeMessage(
    ...
    return processUserMessage.processToolMessage(openAiMessageResponse,
                                                 userListCategories,
                                                 userMessage);
  }
}
